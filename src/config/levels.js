...
// --- Суперспособности ---
//
// Радиус косточки — по ЛАБИРИНТУ (BFS-шаги через distanceMap), не по прямой,
// тем же способом, что уже считает дальность спавна собак (dogReach в GameScene).
export const BONE_RADIUS_TILES = 20;
// Общее время от активации до возврата собак к обычному поведению — не с
// момента прихода к косточке (это потребовало бы отслеживать приход КАЖДОЙ
// собаки отдельно). Включает и подход, и "стояние" — визуально неотличимо.
export const BONE_DISTRACT_MS = 6000;
// На сколько замирает собака, поймавшая котика под щитом.
export const SHIELD_FREEZE_MS = 4000;
// Пикапы способностей на карте. Щит — только там, где есть собаки (на 1-2
// защищать не от кого). Косточка банкуется в инвентарь и годится на будущее,
// поэтому падает на любом уровне. CHANCE — шанс, что пикапы вообще появятся на
// уровне; COUNT — сколько штук, когда появились.
export const SHIELD_MAP_CHANCE = 0.7;
export const SHIELD_MAP_COUNT = 2;
export const BONE_MAP_CHANCE = 0.7;
export const BONE_MAP_COUNT = 2;
...
export const LEVELS = [
  {
    n: 1, cols: 7, rows: 7, braid: 0.30, dogs: 0, coins: 3, safeZones: 4, trampolines: 2,
    spawnDelay: 0, respawnGap: 0,
    hint: 'Веди котика к домику! Собирай монетки.',
  },
  {
    n: 2, cols: 9, rows: 9, braid: 0.18, dogs: 0, coins: 5, safeZones: 5, trampolines: 3,
    spawnDelay: 0, respawnGap: 0,
    hint: 'Лабиринт стал больше. Не заблудись!',
  },
  {
    n: 3, cols: 11, rows: 11, braid: 0.20, dogs: 1, dogSpeed: 0.70, coins: 6, safeZones: 6, trampolines: 3,
    spawnDelay: 5000, respawnGap: 4000,
    hint: 'Осторожно, собака! Прячься в коробку. Батут разгонит тебя!',
  },
  {
    n: 4, cols: 13, rows: 13, braid: 0.22, dogs: 1, dogSpeed: 0.75, coins: 8, safeZones: 6, trampolines: 4,
    spawnDelay: 4500, respawnGap: 3500,
    hint: 'Собака стала шустрее!',
  },
  {
    n: 5, cols: 15, rows: 15, braid: 0.25, dogs: 2, dogSpeed: 0.80, coins: 10, safeZones: 7, trampolines: 4,
    spawnDelay: 4000, respawnGap: 3000,
    hint: 'Теперь их двое!',
  },
  {
    n: 6, cols: 17, rows: 17, braid: 0.27, dogs: 2, dogSpeed: 0.85, coins: 8, safeZones: 7, trampolines: 5,
    spawnDelay: 3500, respawnGap: 3000,
    hint: 'Две собаки, и лабиринт больше.',
  },
  {
    n: 7, cols: 19, rows: 19, braid: 0.30, dogs: 3, dogSpeed: 0.90, coins: 6, safeZones: 8, trampolines: 6,
    spawnDelay: 3000, respawnGap: 2500,
    hint: 'Три собаки! Держись укрытий.',
  },
  {
    n: 8, cols: 19, rows: 19, braid: 0.32, dogs: 3, dogSpeed: 0.95, coins: 5, safeZones: 8, trampolines: 6,
    spawnDelay: 2500, respawnGap: 2200,
    hint: 'Самые быстрые собаки. Держись!',
  },
  {
    n: 9, cols: 19, rows: 19, braid: 0.33, dogs: 3, dogSpeed: 0.97, coins: 5, safeZones: 7, trampolines: 6,
    spawnDelay: 2200, respawnGap: 2000,
    hint: 'Батут закинет тебя далеко — используй его, чтобы оторваться!',
  },
  {
    n: 10, cols: 19, rows: 19, braid: 0.35, dogs: 3, dogSpeed: 0.98, coins: 5, safeZones: 7, trampolines: 6,
...
// Бег теперь единственная скорость котика (кнопку-переключатель убрали —
// одной рукой вести джойстик и одновременно держать кнопку было неудобно,
// а спринт сам по себе оказался приятнее ходьбы). catWalk не нужен.
export const SPEED = {
  catRun: 170,
};
